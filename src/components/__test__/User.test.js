...
describe("React CRUD", () => {
    ...
    test('Edit a user', async () => {
        ...
        users.push(
            {
                userId: 1235, username: "Ameer", email: "ameer@example.com", avatar:"image"
            },
            {
                userId: 1234, username: "Ameer", email: "ameer@example.com", avatar:"image"
            }
        );
        const id =1235;
        const name="Adi";
    ...
    test('Delete a user', async () => {
        ...
        users.push(
            ...
            {
                userId: 1234, username: "Ameer", email: "adi@example.com", avatar:"image"
            }
        );
        const id =1235;
    ...
    test('Delete multiple users', async () => {
        ...
        users.push(
            ...
            {
                userId: 1236, username: "Ameer", email: "ameer@example.com", avatar:"image"
            }
        );
        const id =[1235, 1236];
        const data = await deleteUser(id);
